...
<script>
      <?php
            ...
            $female=$ro2['count'];
            $male=$row['count'];
            $q3="SELECT count(*) as count FROM food_donations where location=\"Kuala Lumpur\"";
            $res3=mysqli_query($connection, $q3);
            $ro3=mysqli_fetch_assoc($res3);
            $kualalumpur=$ro3['count'];
            $q4="SELECT count(*) as count FROM food_donations where location=\"Kuantan\"";
            $res4=mysqli_query($connection, $q4);
            $ro4=mysqli_fetch_assoc($res4);
            $kuantan=$ro4['count'];
            $q5="SELECT count(*) as count FROM food_donations where location=\"Ipoh\"";
            $res5=mysqli_query($connection, $q5);
            $ro5=mysqli_fetch_assoc($res5);
            $ipoh=$ro5['count'];
            $q6="SELECT count(*) as count FROM food_donations where location=\"Kuching\"";
            $res6=mysqli_query($connection, $q6);
            $ro6=mysqli_fetch_assoc($res6);
            $kuching=$ro6['count'];
            $q7="SELECT count(*) as count FROM food_donations where location=\"Klang\"";
            $res7=mysqli_query($connection, $q7);
            $ro7=mysqli_fetch_assoc($res7);
            $klang=$ro7['count'];
            $q8="SELECT count(*) as count FROM food_donations where location=\"Penang\"";
...
var xplace=["Kuala Lumpur","Kuantan","Ipoh","Kuching","Klang","Penang"];
var yplace=[<?php echo json_encode($kualalumpur,JSON_HEX_TAG);?>,<?php echo json_encode($kuantan,JSON_HEX_TAG);?>,<?php echo json_encode($ipoh,JSON_HEX_TAG);?><?php echo json_encode($kuching,JSON_HEX_TAG);?>,<?php echo json_encode($klang,JSON_HEX_TAG);?>,<?php echo json_encode($penang,JSON_HEX_TAG);?>];
